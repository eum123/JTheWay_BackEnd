package net.haaim.web.api.system.security.jwt;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter{
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("JwtAuthenticationFilter.attemptAuthentication ::::" + request.getMethod());
		/*
		 * POST로 넘어왔는지 체크
		 */
		if (postOnly && (HttpMethod.POST != HttpMethod.valueOf(request.getMethod()))) {
