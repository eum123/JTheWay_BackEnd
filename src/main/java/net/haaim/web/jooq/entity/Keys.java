...
public class Keys {
    ...
    public static final UniqueKey<JClassMngtRecord> KEY_CLASS_MNGT_PRIMARY = UniqueKeys0.KEY_CLASS_MNGT_PRIMARY;
    ...
    public static final UniqueKey<JExamItemRecord> KEY_EXAM_ITEM_PRIMARY = UniqueKeys0.KEY_EXAM_ITEM_PRIMARY;
    public static final UniqueKey<JExamListRecord> KEY_EXAM_LIST_PRIMARY = UniqueKeys0.KEY_EXAM_LIST_PRIMARY;
    public static final UniqueKey<JExamUserRecord> KEY_EXAM_USER_PRIMARY = UniqueKeys0.KEY_EXAM_USER_PRIMARY;
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<JClassMngtRecord> KEY_CLASS_MNGT_PRIMARY = Internal.createUniqueKey(JClassMngt.CLASS_MNGT, "KEY_class_mngt_PRIMARY", new TableField[] { JClassMngt.CLASS_MNGT.STUDENT_NO, JClassMngt.CLASS_MNGT.DATE }, true);
        ...
        public static final UniqueKey<JExamItemRecord> KEY_EXAM_ITEM_PRIMARY = Internal.createUniqueKey(JExamItem.EXAM_ITEM, "KEY_exam_item_PRIMARY", new TableField[] { JExamItem.EXAM_ITEM.EXAM_NO, JExamItem.EXAM_ITEM.NO, JExamItem.EXAM_ITEM.ITEM_NO }, true);
        ...
        public static final UniqueKey<JExamUserRecord> KEY_EXAM_USER_PRIMARY = Internal.createUniqueKey(JExamUser.EXAM_USER, "KEY_exam_user_PRIMARY", new TableField[] { JExamUser.EXAM_USER.EXAM_NO, JExamUser.EXAM_USER.STUDENT_NO }, true);
